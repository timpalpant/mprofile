// Adapted from heapprof (MIT).

#ifndef MPROFILE_SRC_REENTRANT_SCOPE_H_
#define MPROFILE_SRC_REENTRANT_SCOPE_H_
...
class ReentrantScope {
 public:
  ReentrantScope() : is_top_level_(!in_malloc_) { in_malloc_ = true; }
 ...
 private:
  ...
  // exit, and we only do profiling at that outermost level.
  static thread_local bool in_malloc_;

  bool is_top_level_;
};

#endif  // MPROFILE_SRC_REENTRANT_SCOPE_H_
